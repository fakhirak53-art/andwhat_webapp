      ...
      <div className="relative z-10 max-w-screen-xl mx-auto px-6 md:px-10 lg:px-16">
        ...
        >
          ...
          <div className="py-12 sm:py-16 lg:py-20">
            ...
            >
              <BrandName /> sits quietly in the background of any website your students visit.
              Before a distraction loads, they answer one quick question from your course
              material. Simple for them. Useful for you.
            </p>
