  ...
  return (
    <section className="relative overflow-hidden">
      ...
      >
        ...
        >
          <BrandName tone="onDark" /> Daily Messaging provides practical, person-centred support to help you
          build resilience and develop independence. We focus on helping you achieve your
          mental health and wellbeing outcomes&mdash;starting in your NDIS plan.
        </p>
